...
function App() {
  ...
  const chambers = [
    { name: 'Unihealth - Multi-speciality Polyclinic', location: 'Santoshpur', phone: '8910767623', map: 'Unihealth Multi-speciality Polyclinic Santoshpur Kolkata' },
    { name: 'Libberton Orthopaedics Centre', location: 'Kalikapur', phone: '8420012671', map: 'Libberton Orthopaedics Centre Kalikapur Kolkata' },
    { name: 'Longlife Speciality Clinic', location: 'Mukundapur', phone: '9874807480', map: 'Longlife Speciality Clinic Mukundapur Kolkata' },
    { name: 'Healthora Polyclinic', location: 'Rathtala, Kasba', phone: '9147172333', map: 'Healthora Polyclinic Rathtala Kasba Kolkata' },
  ]
  ...
  return (
    <main>
      ...
      <section className="hero" id="top"><div className="hero-copy"><p className="eyebrow">অস্থি রোগ বিশেষজ্ঞ · Kolkata</p><h1>Movement is<br /><em>medicine.</em></h1><p className="hero-lede">Thoughtful, precise orthopaedic care for a life in motion.</p><a className="primary-button" href="#booking">Schedule a consultation <ArrowUpRight size={17} /></a><div className="hero-note"><span className="status-dot" /> Accepting new patients <span className="note-rule" /> <span>English · বাংলা · हिंदी</span></div></div><div className="hero-portrait"><div className="portrait-frame"><img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?auto=format&fit=crop&w=900&q=85" alt="Doctor in a white coat" /></div><div className="portrait-caption"><span>01</span><span>Care rooted in clarity</span></div><div className="seal">CARE<br /><span>with</span><br />INTENT</div></div></section>
